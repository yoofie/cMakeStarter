$export_name = "exported.zip"

$compress = @{
	Path             = ".\src", ".\vendor", ".\support", ".\lib", ".\.vscode", ".\.clang-format", ".\.gitignore", ".\CMakeLists.txt", ".\dev.bat", ".\nlohmann_json.natvis", ".\clang-build.ps1", ".\justfile", ".\readme.md"
